...
\begin{figure}[H]
  ...
  \end{figure}
    ...
    \texttt{graph\_functions.h} : Ce fichier assure la liaison entre la représentation géométrique graph (en coordonnées axiales pour un pavage hexagonal) et sa représentation sous forme de structure graphe qui est exploité par les algorithmes . \\
    \texttt{strategies.h et strategie3.h}: Ces fichiers regroupent les fonctions liées aux stratégies de jeu, telles que l’algorithme de Dijkstra, le TSP(problème du voyageur de commerce), la pose de murs, et les choix des mouvements intelligents du joueur.\\
